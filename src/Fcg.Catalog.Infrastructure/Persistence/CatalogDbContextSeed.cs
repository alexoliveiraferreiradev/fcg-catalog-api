        ...
        public static async Task SeedDataAsync(CatalogDbContext context)
        {
            ...
            if (!await context.Games.AnyAsync())
            {
                context.Games.AddRange(
                    ...
                    new Game(new Name("The Witcher 3: Wild Hunt"), new Description("Torne-se o bruxo Geralt de Rivia e embarque em uma jornada épica em busca da criança da profecia em um mundo aberto devastado pela guerra."), new Price(129.90m), GameGenre.RPG),
                    ...
                    new Game(new Name("God of War Ragnarök"), new Description("Kratos e Atreus devem embarcar em uma jornada mítica pelos Nove Reinos em busca de respostas enquanto as forças asgardianas se preparam para a batalha profetizada."), new Price(299.90m), GameGenre.Acao),
