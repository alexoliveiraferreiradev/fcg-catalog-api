...
namespace Fcg.Catalog.Application.Features.Catalog.EventHandlers
{
    public class PromotionDeactivatedCacheHandler : INotificationHandler<PromotionDeactivatedEvent>
    {
        ...
        {
            _logger.LogInformation("[CatalogAPI] [Cache] Iniciando limpeza de cache após desativação de promoção. PromotionId: {PromotionId}, GameId: {GameId}", notification.PromotionId, notification.GameId);
