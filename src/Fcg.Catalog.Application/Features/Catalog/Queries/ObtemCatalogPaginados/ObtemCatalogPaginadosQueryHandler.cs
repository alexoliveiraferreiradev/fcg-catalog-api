...
{
    public class ObtemCatalogPaginadosQueryHandler : IRequestHandler<ObtemCatalogPaginadosQuery, PagedResult<JogoResponse>>
    {
        private readonly IDbConnection _dbConnection;
        private readonly ICacheService _cacheService;

        public ObtemCatalogPaginadosQueryHandler(IDbConnection dbConnection,
