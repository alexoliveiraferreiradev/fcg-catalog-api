...
using Fcg.Catalog.Application.Features.Library.Queries.ObtemBibliotecaPaginada;
using MediatR;
...
namespace Fcg.Catalog.API.Endpoints.Usuario
{
    public static class BibliotecaUsuarioEndpoint
    {
        ...
        {
            var group = app.MapGroup("/api/usuario/Library").RequireAuthorization("AcessoGeral").WithTags("Library do Usuário");
