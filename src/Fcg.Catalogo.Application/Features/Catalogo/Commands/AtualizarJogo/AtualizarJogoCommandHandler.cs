...
namespace Fcg.Catalogo.Application.Features.Catalogo.Commands.AtualizarJogo
{
    ...
    public class AtualizarJogoCommandHandler : IRequestHandler<AtualizarJogoCommand, JogosResponse>
    {
        ...
        public async Task<JogosResponse> Handle(AtualizarJogoCommand request, CancellationToken cancellationToken)
        {
